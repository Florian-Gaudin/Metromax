...
<header class="bg-bg2">
    ...
    <h1 class="font-bungee py-5 text-5xl text-primary text-center">Découvrez nos offres</h1>
    <div class="bg-bg-cine bg-[center_left_62rem] md:bg-[left_0rem] md:bg-cover flex flex-col md:flex-row justify-around py-20">

    <!-- CARD 1 -->
    <div class="mx-5 md:mx-0 md:w-full md:max-w-sm p-4 mt-5 bg-card bg-blend-hard-light bg-opacity-80 border border-gray-200 rounded-lg shadow sm:p-8 font-impact font-medium uppercase">
        ...
        <div class="flex justify-center">
            <button type="button" class="w-9/12 text-primary font-medium rounded-lg bg-secondary text-lg px-3 md:px-5 py-2.5 w-full text-center uppercase">Accéder au catalogue</button>
        </div>
...
<section class="bg-bg2 md:pt-[10px] md:pb-[70px]">
...
<section class="bg-bg1 pt-[10px] pb-[50px] ">
