...
<!-- : version mobile first / version desktop gérée par l'ajout de "md:" -->
  ...
  <div class="flex flex-row-reverse md:flex-row flex-wrap items-center justify-around md:justify-between ">
    ...
    <div class="relative w-full">
        ...
        <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-7 p-1" placeholder="Chercher un film" required>
    </div>
