  ...
  <div class="flex flex-row-reverse md:flex-row flex-wrap items-center justify-around md:justify-between ">
    ...
    <form class="flex items-center mt-5 md:mt-0">   
        ...
        <div class="relative w-full">
            ...
            <input type="text" id="simple-search" class="bg-primary border border-gray-300 text-bg1 font-impact text-sm placeholder:text-impact placeholder:text-bg1 placeholder:text-bold rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-7 p-1" placeholder="Chercher un film" required>
        </div>
